...
if ($_POST['tabela']=="WDW" or $_POST['tabela']=="biblAutor_biblTytul"){
    ...
    $sql = "SELECT count(".$opcja.") as wynik FROM `aaaaaaa_tojestbazadanych`.WDW where ".$opcja."=".$_POST['id'];
...
if ($conn->query($sql) === TRUE) {
    header('Location: https://sebastian-swoboda.herokuapp.com/grid/index.php');
echo $sql;
} else {
