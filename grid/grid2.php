...
<body>
    ...
    <div class="str2">
        ...
        <?php
                        ...
                        $sql = "select Klasa, `Imie-Nazwisko`, (`WDW`.ID) as ID_TAB from `aaaaaaa_tojestbazadanych`.WDW, `aaaaaaa_tojestbazadanych`.Klasa, `aaaaaaa_tojestbazadanych`.Osoby where Osoby.ID=osoby_id and Klasa.ID=klasa_id order by ID_TAB asc";
